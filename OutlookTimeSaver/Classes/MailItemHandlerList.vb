Public Class MailItemHandlerList
    ...
    Public Shared Sub Add(p_MailItem As Outlook.MailItem, p_IsInlineResponse As Boolean, p_SetSalutation As Boolean)

        m_MailItemHandlers.Add(New MailItemHandler(p_MailItem, p_IsInlineResponse, p_SetSalutation))
